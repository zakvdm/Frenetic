    ...
    public class VariableFloatTypeConverter : ExpandableObjectConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(string) && value is VariableFloat)
            {
                ...
                return String.Format("{1}{0}{2}", culture.TextInfo.ListSeparator + " ", vfloat.Anchor, vfloat.Variation);
            }
                    ...
                    case 1:
                        {
                            ...
                            {
                                Anchor = (float)converter.ConvertFromString(context, culture, values[0]),
                                Variation = 0f
                            };
                        }
                    case 2:
        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            return new PropertyDescriptorCollection(new PropertyDescriptor[]
                {
                    new SmartMemberDescriptor(type.GetField("Anchor"),
