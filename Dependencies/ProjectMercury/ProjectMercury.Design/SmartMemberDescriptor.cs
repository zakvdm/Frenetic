namespace ProjectMercury.Design
{
    ...
    public class SmartMemberDescriptor : PropertyDescriptor
    {
        ...
        public SmartMemberDescriptor(FieldInfo field)
        ...
        public SmartMemberDescriptor(FieldInfo field, params Attribute[] attributes)
        ...
        public SmartMemberDescriptor(PropertyInfo property)
        ...
        /// <param name="property">The property.</param>
        /// <param name="attributes">The attributes.</param>
        public SmartMemberDescriptor(PropertyInfo property, params Attribute[] attributes)
