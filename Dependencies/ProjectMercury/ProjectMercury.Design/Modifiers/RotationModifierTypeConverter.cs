namespace ProjectMercury.Design.Modifiers
{
    ...
    public class RotationModifierTypeConverter : ExpandableObjectConverter
    {
        /// <summary>
        ...
        {
            var type = typeof(RotationModifier);

            return new PropertyDescriptorCollection(new PropertyDescriptor[]
            {
                new SmartMemberDescriptor(type.GetField("RotationRate"),
                    new DisplayNameAttribute("Rotation Rate"),
                    new DescriptionAttribute("The Particles rate of rotation in radians per second."))
            });
        }
    }
}