...
namespace Frenetic.Autofac
{
    public class PlayerModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.Register((c,p) => new LocalPlayer(c.Resolve<LocalPlayerSettings>(), c.Resolve<LocalPlayerFarseerPhysicsComponent>(), c.Resolve<IBoundaryCollider>(), c.Resolve<IWeapons>(), c.Resolve<ITimer>())).As<LocalPlayer>().FactoryScoped();
