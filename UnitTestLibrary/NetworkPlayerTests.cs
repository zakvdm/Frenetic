...
namespace UnitTestLibrary
{
    ...
    public class NetworkPlayerTests
    {
        ...
        public void UpdatePositionFromNetworkDoesntMoveCurrentPosition()
        {
            ...
            player.UpdatePositionFromNetwork(new Vector2(110, 180), 0.1f);
        ...
        public void TestVelocityForSimplePrediction()
        {
            ...
            player.UpdatePositionFromNetwork(new Vector2(10, 15), 1f);
        ...
        public void WorksWhenPredictionWasWrong()
        {
            ...
            // CREATE A PREDICTION:
            player.UpdatePositionFromNetwork(new Vector2(20, 25), 1f);  // prediction: (30, 30)
            ...
            player.UpdatePositionFromNetwork(actualReceivedPosition, 1f); // So the estimate was out by (1, -2)
        ...
        public void AdjustsForTime()
        {
            ...
            player.UpdatePositionFromNetwork(new Vector2(20, 25), 0.1f);
