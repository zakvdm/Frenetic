...
namespace UnitTestLibrary
{
    ...
    public class NetworkPlayerControllerTests
    {
        ...
        public void SetUp()
        {
            ...
            npController.Players.Add(1, new Player(1));
        ...
        {
            Player receivedPlayer = new Player(1);
        ...
        {
            Player receivedPlayer1 = new Player(1);
            Player receivedPlayer2 = new Player(2);
            ...
            npController.Players.Add(2, new Player(2));
